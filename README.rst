...
.. code-block:: bash
    ...
    heroku run python repo_name/manage.py syncdb --noinput --settings=config.settings
    heroku run python repo_name/manage.py migrate --settings=config.settings
    heroku run python repo_name/manage.py collectstatic --settings=config.settings
